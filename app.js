...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function renderAuthState() {
        ...
        if (user) {
            ...
            // Admin Yetkisi Varsa (veya vuskantech kullanıcısı ise) Admin Paneli Butonunu Göster
    ...
    function renderAdminPanel() {
        ...
        container.innerHTML = users.map(user => `
            <tr>
                <td><strong>${user.username}</strong> ${user.username.toLowerCase() === 'vuskantech' ? '<span class="user-role-tag admin">ADMIN</span>' : ''}</td>
