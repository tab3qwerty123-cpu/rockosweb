...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Vercel Serverless Live Download Stats Fetcher
    async function fetchLiveDownloadStats() {
        const counterElement = document.getElementById("total-download-count");
        ...
        try {
            ...
            if (res.ok) {
                ...
                if (data && data.downloads && data.downloads.total) {
                    counterElement.textContent = `${data.downloads.total}+`;
                }
            }
        } catch (e) {
